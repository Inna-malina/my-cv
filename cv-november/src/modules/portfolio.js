const portfolio = {
  "rs-school": {
    "portfolio-1": {
      "top": "Истории о животных",
      "text": "Проект о животных. Имеет кроссбраузерную, адаптивную вёрстку. В проекте использовались карусели с плавной анимацией при перелистывани элементов; попапы в меню и в блоке отзывов. Так же на второй странице применялись интерактивные элементы при выборе суммы пожертвования.",
      "githubcode": "https://github.com/Inna-malina/rs-school/tree/zoo/zoo",
      "linkproject": "https://inna-malina.github.io/rs-school/zoo/index.html",
    ...
    "carousel":['assets/rs-school-carousel__1.jpg', 'assets/rs-school-carousel__2.jpg', 'assets/rs-school-carousel__3.jpg'],
  },
  "animation": {
    "portfolio-1": {
      "top": "Байкал",
